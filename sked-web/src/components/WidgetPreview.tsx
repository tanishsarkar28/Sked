...
export const WidgetPreview: React.FC = () => {
  ...
  const widgetClasses: Record<string, { code: string; time: string; room: string; type: string; status: 'LIVE' | 'NEXT' | 'DONE' | 'UPCOMING' }[]> = {
    MON: [
      { code: 'CSE408', time: '10:20-11:10', room: '34-101', type: 'LEC', status: 'DONE' },
      { code: 'INT252', time: '11:10-12:00', room: '33-507Y', type: 'PRAC', status: 'LIVE' },
      { code: 'PEA306', time: '14:40-15:30', room: '34-101', type: 'LEC', status: 'NEXT' },
    ],
    TUE: [
      { code: 'MKT311', time: '09:30-10:20', room: '37-905', type: 'PRAC', status: 'DONE' },
      { code: 'INT252', time: '12:50-13:40', room: '33-507Y', type: 'PRAC', status: 'LIVE' },
      { code: 'CSE408', time: '15:30-16:20', room: '34-101', type: 'LEC', status: 'NEXT' },
    ],
    WED: [
      { code: 'INT252', time: '10:20-11:10', room: '33-507Y', type: 'PRAC', status: 'DONE' },
      { code: 'INT252', time: '11:10-12:00', room: '33-507Y', type: 'PRAC', status: 'DONE' },
      { code: 'PEA306', time: '13:40-14:30', room: '34-101', type: 'LEC', status: 'LIVE' },
      { code: 'MKT311', time: '14:40-15:30', room: '37-905', type: 'PRAC', status: 'NEXT' },
    ],
    THU: [
      { code: 'INT252', time: '10:20-11:10', room: '33-507Y', type: 'PRAC', status: 'DONE' },
      { code: 'INT252', time: '11:10-12:00', room: '33-507Y', type: 'PRAC', status: 'DONE' },
      { code: 'MKT311', time: '12:50-13:40', room: '37-905', type: 'PRAC', status: 'LIVE' },
      { code: 'CSE408', time: '13:40-14:30', room: '34-101', type: 'LEC', status: 'NEXT' },
      { code: 'PEA306', time: '16:10-17:00', room: '34-101', type: 'LEC', status: 'UPCOMING' },
    ],
    FRI: [
      { code: 'CSE408', time: '09:30-10:20', room: '34-101', type: 'LEC', status: 'DONE' },
      { code: 'INT252', time: '10:20-11:10', room: '33-507Y', type: 'PRAC', status: 'DONE' },
      { code: 'INT252', time: '11:10-12:00', room: '33-507Y', type: 'PRAC', status: 'LIVE' },
      { code: 'MKT311', time: '12:50-13:40', room: '37-905', type: 'PRAC', status: 'NEXT' },
      { code: 'PEA306', time: '14:40-15:30', room: '34-101', type: 'LEC', status: 'UPCOMING' },
    ],
    SAT: [
      { code: 'PEA306', time: '09:30-10:20', room: '34-101', type: 'LEC', status: 'DONE' },
      { code: 'MKT311', time: '11:10-12:00', room: '37-905', type: 'PRAC', status: 'LIVE' },
    ],
    SUN: [],
  };
  ...
  const statusColor = (s: string) => {
    switch (s) {
      case 'LIVE': return { dot: 'bg-[#FF6B1A]', text: 'text-[#FF6B1A]' };
      case 'NEXT': return { dot: 'bg-[#FF8533]', text: 'text-[#FF8533]' };
      case 'DONE': return { dot: 'bg-[#3A3A3A]', text: 'text-[#7A7774]' };
      default: return { dot: 'bg-[#818CF8]', text: 'text-[#818CF8]' };
    }
  };
    ...
    <section id="widget" className="py-24 px-6 max-w-7xl mx-auto border-t border-[#252525]">
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-[#7A7774] text-lg max-w-2xl mx-auto">
          A resizable Jetpack Glance widget that sits on your home screen. See today's classes, live departures, and room numbers — without ever opening the app.
        </p>
      </div>
